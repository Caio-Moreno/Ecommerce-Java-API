...
public class ImagemDAO {
    ...
    public static boolean inserirImagens (Imagem imagem, int id) throws IOException {
        ...
        String sqlUpdate = "INSERT INTO IMAGENS(ID, CAMINHO, ID_PRODUTO_FK) VALUES(DEFAULT, ?, ?);";
        ...
        try {
            ...
            if(!(imagem.getCaminhoImagem2() == null)){
                ps.setString(1,imagem.getCaminhoImagem2());
                ps.setInt(2, id);
                ps.execute();
            }
            if(!(imagem.getCaminhoImagem3() == null)){
                ps.setString(1,imagem.getCaminhoImagem3());
                ps.setInt(2, id);
                ps.execute();
            }
            if(!(imagem.getCaminhoImagem4() == null)){
