...
public class Produto {
	...
	public Produto(int _idProduto, String _nomeProduto, String _nomeExtenso, double _qualidadeProduto, String _categoria, String _statusProduto, int _qtdEstoque, double _preço) {
