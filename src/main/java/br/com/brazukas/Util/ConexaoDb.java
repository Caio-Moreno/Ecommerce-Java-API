...
public class ConexaoDb {
    ...
    private static String _connectionString = "jdbc:mysql://localhost:3306/BRAZUKAS?useTimezone=true&serverTimezone=UTC&useSSL=false";
    private static String _username ="root";
    private static String _password = "230815";
